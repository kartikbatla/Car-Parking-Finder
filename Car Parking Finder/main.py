...
# Video feed
cap = cv2.VideoCapture('C:\\Users\\batla\\OneDrive\\Desktop\\coding\\Car Parking Finder\\carPark.mp4')
with open('C:\\Users\\batla\\OneDrive\\Desktop\\coding\\Car Parking Finder\\CarParkPos', 'rb') as f:
...
def checkParkingSpace(imgPro, img):
    ...
    cvzone.putTextRect(img, f'Available spots : {spaceCounter}/{len(posList)}', (50, 50), scale=2, thickness=1, offset=2, colorR=(0, 0, 0))
